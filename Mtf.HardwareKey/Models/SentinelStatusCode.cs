...
namespace Mtf.HardwareKey.Models
{
    public sealed class SentinelStatusCode
    {
        ...
        public static readonly SentinelStatusCode UnknownError = new SentinelStatusCode(UInt16.MaxValue, "Unknown error occured, check if Sentinel's driver is installed.");
